...
// WiFi credentials
#define WIFI_SSID "talha"
#define WIFI_PASSWORD "12345678"

// Firebase credentials
#define FIREBASE_HOST "agro-scan-140ac-default-rtdb.firebaseio.com/"
#define FIREBASE_AUTH "yLTB7lIwAmyt8HVEAwUYJcl81iLVHZKYqmZweeoM"
...
void loop() {
  ...
  Firebase.setInt(firebaseData, "/SoilMoisture", soilMoisturePercent);
  Firebase.setString(firebaseData, "/RainStatus", rainStatus);
